...
export const AGENT_INFO: AgentDesc[] = [
  { name: 'v13', desc: 'KME3-TUNED v4 DUAL-OPPONENT — lõi H=6/LO=144/HI=712, prefire h21+h22, V231-flip điều kiện, V224 sales-first, R37 reorder mở từ step 144, melon-seller mọi giờ · 48/48 thắng kme3 (+$3.9k), 8/8 thắng kme3v10 (+$2.6k) và aurax (+$2.6k) · v12 (tiền nhiệm) và dra (bản sao MD5 kme3) đã nghỉ hưu (chi tiết §11.23-24)', tag: 'nhà vô địch' },
  { name: 'kme3', desc: 'MASTER ENGINE V3 (guruprasaathas111, Kaggle public, Apache 2.0) — route-tape 719-turn + 20 lớp overlay, Public Score 600 · tự đấu hòa tuyệt đối · bị v13 vượt 48/48 (chi tiết §11.21-24)', tag: 'đối thủ chuẩn' },
  { name: 'kme3v10', desc: 'MASTER ENGINE V3 — PHIÊN BẢN 10 (guruprasaathas111, Kaggle public, cập nhật 2026-09-13) — code KHÁC kme3 (v9): MD5 4593a884…, 2.626 dòng (+270): R51 beam-search input-path (width 8), R68 joint multi-worker plans, R62 deterministic HIRE spawn, R70/R79 fertilizer adaptive (bỏ qty cố định 10 / giá ≤30), EXP193 · mạnh hơn kme3 +$1.8k nhưng thua v13 8/8 (chi tiết §11.25)', tag: 'đối thủ mạnh nhất' },
  { name: 'aurax', desc: 'SHOP-ROUTER REACTIVE V4 (aurax7, Kaggle public, version 3, pull 2026-09-13) — code KHÁC kme3/kme3v10: MD5 8230b5a9…, 2.766 dòng (+140): R36 sale-lead window mở sớm hơn (day 9 thay vì day 12), R60 SURVIVAL — lớp cứu hộ giờ 22 FEED động vật sắp chết đói 2 ngày liền (tránh mất $300-500/con), R60 opening liquidity guard (giữ $4 thuê lao động ngày 1) · ngang sức kme3v10, thua v13 8/8 (chi tiết §11.26)', tag: 'đối thủ mới aurax' },
]
