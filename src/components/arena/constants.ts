...
export const AGENT_INFO: AgentDesc[] = [
  ...
  { name: 'v16', desc: 'ARI CLASS Mk-IV (Task 76) — Mk-III + H7 IMPACT MODEL (port Kaito v43): thay key xếp SELL cùng turn của tầng R37 bằng impact chính xác qty × (quote_hiện − quote_sau_tự_đổ) dùng bảng giá engine 1.32.7 + impact_slots mode · Comment/docstring strip toàn bộ (verify đồng-dollar 4/4) · Matrix 330 trận Task 76: thắng 8/10 +$138 vs Mk-III (0 thua), 10/10 trước toàn bộ 9 đối thủ — v15/v14 +$352, v13/kme3 +$3.9k, kme3v10/aurax +$2.9k, kme3v39 +$2.7k, kawashigi +$27.7k, indark_e776 +$22.4k · Đối đầu trực tiếp thắng cả v16h5 (0/10 −$215) lẫn v16h57 (h57 thua −$91)', tag: 'nhà vô địch' },
