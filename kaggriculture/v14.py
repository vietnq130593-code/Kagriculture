# v14 — ARI CLASS (Task 69, 2026-09-13)
# Base: kme3v10 (guruprasaathas111 Master Engine V3 notebook v10, Apache-2.0 lineage)
# + 6 tuning layers from v13 (H/LO/HI window, V231-flip>=3, V224@144, R37-quote@144,
#   nocap reserve + WHEAT/FERT unlocked, prefire h21+22, melon-seller, planner 256/2/16)
# + NEW v14 stack (measured vs v13, seeds 100-103, 2 seats):
#   [front_run=True + opponent_plan sync]  H5 pre-emption of the mirror opponent's
#     scheduled premium dumps (public shop-draw -> exact route/tape prediction)
#   [_V12_HORIZON = 8]                     horizon race vs v13's H=6 (+$2.6k)
#   [room_guard = True]                    chassis layer re-enabled (+$1.0k)
#   [clamp_sells = True]                   chassis layer re-enabled (+$0.5k)
