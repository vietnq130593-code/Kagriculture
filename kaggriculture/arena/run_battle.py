...
AGENTS = {
    ...
    "kme3_noflip": (os.path.join(ROOT, "kme3_noflip.py"), "agent"),
    "v12": (os.path.join(ROOT, "v12.py"), "agent"),
    "v12aa": (os.path.join(ROOT, "v12aa.py"), "agent"),
    "v12ab": (os.path.join(ROOT, "v12ab.py"), "agent"),
    "v12ac": (os.path.join(ROOT, "v12ac.py"), "agent"),
    "v12ad": (os.path.join(ROOT, "v12ad.py"), "agent"),
    "v12ae": (os.path.join(ROOT, "v12ae.py"), "agent"),
    "v12af": (os.path.join(ROOT, "v12af.py"), "agent"),
