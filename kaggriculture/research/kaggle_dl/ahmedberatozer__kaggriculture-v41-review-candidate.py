...
os.chdir(WORKDIR)
print('V41 started. No training, download or installation is needed.', flush=True)
...
EXPECTED_MAIN_SHA256 = '8951ff93742015cba535b125223cf2e541bb7b602080fc4584f30c2613d210f3'
...
namespace = {}
exec(compile(source_bytes, '<v41>', 'exec'), namespace)
...
ARCHIVE = WORKDIR / 'submission_competitive_v41_REVIEW.tar.gz'
EXPECTED_ARCHIVE_SHA256 = '38a7ee013ada392f2fa1872b192537234c4e37ce525b668fa1bbdb7a69b06008'
...
build_manifest = {
    'version': 'v41', 'classification': 'review_candidate',
    'current_population_confirmation_passed': False, 'competitive_gate_status': 'FAILED_ELITE_POINT_CI',
    'independent_working_policy_confirmation_passed': True,
    'protocol': 'EXP259 WIN-primary', 'main_sha256': EXPECTED_MAIN_SHA256,
...
(WORKDIR / 'v41_manifest.json').write_text(json.dumps(build_manifest, indent=2))
print('REVIEW PACKAGE READY:', ARCHIVE.name, '|', ARCHIVE.stat().st_size, 'bytes', flush=True)
...
if not RUN_GAME_CHECKS:
    ...
    if engine_version != '1.32.7':
        ...
        (WORKDIR / 'v41_smoke_results.json').write_text(json.dumps(games, indent=2))
