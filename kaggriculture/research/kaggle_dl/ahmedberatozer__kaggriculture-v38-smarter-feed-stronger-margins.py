...
os.chdir(WORKDIR)
print('V38 started. No training, download or installation is needed.', flush=True)
...
ARCHIVE = WORKDIR / 'submission_competitive_v38.tar.gz'
EXPECTED_ARCHIVE_SHA256 = 'b26150d36f370fbb246686d889096d7491be70693fa6b29ce97154b1d1c2aada'
...
build_manifest = {
    'version': 'v38', 'classification': 'qualified_release_candidate',
    'original_independent_gate_passed': True, 'main_sha256': EXPECTED_MAIN_SHA256,
...
(WORKDIR / 'v38_manifest.json').write_text(json.dumps(build_manifest, indent=2))
...
if not RUN_GAME_CHECKS:
    ...
    if engine_version != '1.32.7':
        ...
        (WORKDIR / 'v38_smoke_results.json').write_text(json.dumps(games, indent=2))
