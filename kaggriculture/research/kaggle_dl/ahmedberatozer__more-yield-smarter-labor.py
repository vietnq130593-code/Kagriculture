...
os.chdir(WORKDIR)
print('V37 started. No training, download or installation is needed.', flush=True)
...
EXPECTED_MAIN_SHA256 = '94c1c2c05ae7cde8fca9ee3957b01112c1cbab82c7434aae6a5f24fa7485bc4c'
...
namespace = {}
exec(compile(source_bytes, '<v37>', 'exec'), namespace)
...
ARCHIVE = WORKDIR / 'submission_competitive_v37.tar.gz'
EXPECTED_ARCHIVE_SHA256 = 'ad5c77c44391ce8718183ce281196bc62441001d753d7f7ad3934366c7af44a8'
...
build_manifest = {
    'version': 'v37', 'classification': 'release_candidate',
...
(WORKDIR / 'v37_manifest.json').write_text(json.dumps(build_manifest, indent=2))
...
if not RUN_GAME_CHECKS:
    ...
    if engine_version != '1.32.7':
        ...
        (WORKDIR / 'v37_smoke_results.json').write_text(json.dumps(games, indent=2))
