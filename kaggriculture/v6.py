# v6 "ORCHESTRATOR-K" — v6.6 (Task 27, 23 Sep): kain16 chassis + 1 DELTA E8-LITE
# v5-HERD-ENGINE (đúc kết từ 2 battery v5-chassis thất bại — twin-kernel trap).
#
...
def _daily_plan(tiles, shed, seeds, inv, prices, shops, day, opp_farm, money, tm=None):
    ...
    _herd_cap = 15 if (day >= 11 or money >= 3000) else 13
