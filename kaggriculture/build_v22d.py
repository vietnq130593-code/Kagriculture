...
Run from the project root:  python3 build_v22d.py
"""
import os
...
v20_src = read("v20.py")
v22d_layer = read("v22d_layer.py")

v22d_layer = v22d_layer.replace(
    "_V22D_HOST = agent  # noqa: F821  (flat chain: v19.4's entry point)",
...
# Chain (identical logic to v20.py + v22d_layer.py, single namespace):
...
def agent(observation, configuration=None):
    return _V22D_ENTRY(observation, configuration)
...
out_path = os.path.join(ROOT, "v22d.py")
with open(out_path, "w", encoding="utf-8") as f:
    f.write(src)

size = os.path.getsize(out_path)
print(f"v22d.py written: {size:,} bytes")
