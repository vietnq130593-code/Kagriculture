...
# Production-entry sanity (kaggle callable-selection rule, học từ v65):
# module phải resolve về `agent` — layer v25 là def `agent` cuối cùng, các
# rebind sau đây không đụng đến tên đó.
