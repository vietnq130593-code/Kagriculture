...
def _bayes_step(tm, day, opp_farm, my_herd, my_money):
    ...
    try:
        ...
        # v5.4 Phase 5.5: PROFILES HỌC TỪ SỐ LIỆU (bench/profiles_learned.json,
        # 5 seed/bot × ngày 7-28, telemetry $0-residual) — thay cho giá trị tay.
        # Phát hiện then chốt: WHEAT CONTEST tay=25, đo thực v4=0.7 (churn hai
        # chiều P25 −9/P75 +11) — đây là nguồn gốc L1 đọc nhầm r1-r4.
        PROFILES = {
            "CONTEST": {"WHEAT": 0.7, "CARROT": 0.5, "TOMATO": 0.1, "STRAWBERRY": 1.6,
                        "MELON": 2.5, "EGG": 5.4, "MILK": 2.5, "WOOL": 2.6, "FERTILIZER": 7.9},
            "COOP":    {"WHEAT": 0.1, "CARROT": 1.3, "TOMATO": 0.1, "STRAWBERRY": 1.6,
                        "MELON": 3.4, "EGG": 3.8, "MILK": 2.0, "WOOL": 2.0, "FERTILIZER": 6.5},
            "PASSIVE": {"WHEAT": 6.5, "CARROT": 5.9, "TOMATO": 1.8, "STRAWBERRY": 2.4,
                        "MELON": 5.6, "EGG": 0.3, "MILK": 0.3, "WOOL": 0.3, "FERTILIZER": 0.3},
            "DUMP":    {"WHEAT": 0.1, "CARROT": 0.1, "TOMATO": 0.1, "STRAWBERRY": 0.1,
                        "MELON": 0.6, "EGG": 0.1, "MILK": 0.1, "WOOL": 0.1, "FERTILIZER": 0.1},
        }
