# kain33 "KAGGLE-4-LAWS" (Task 32) — kain31 + 3 LUẬT ĐẤT CỨNG (top Kaggle):
# NE d5-7 · SW d10-12 · KHÔNG SE (75 ô tối đa) — không đụng gì khác.
...
_SEED_INFO = []
try:
    _TRACE_F = open("/tmp/kain33t_trace.jsonl", "a", buffering=1)
except Exception:
    _TRACE_F = None
