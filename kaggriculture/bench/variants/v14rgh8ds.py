...
del _PAYLOAD
_SETTINGS={'hand_align': True, 'weed_repair': True, 'sell_lead': True, 'budget_guard': False, 'room_guard': True, 'clamp_sells': False, 'dead_stock': True, 'terminal_liquidation': False, 'front_run': True}
