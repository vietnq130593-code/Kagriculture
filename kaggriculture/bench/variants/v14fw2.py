...
del _PAYLOAD
_SETTINGS={'hand_align': True, 'weed_repair': True, 'sell_lead': True, 'budget_guard': False, 'room_guard': False, 'clamp_sells': False, 'dead_stock': False, 'terminal_liquidation': False, 'front_run': True}
...
def _v219_request(obs, action, state, native):
    ...
    fertilizer=bool(_V219_FERTILIZE and day in (18,21,24,27) and _r79_tomato_fertilizer_worthwhile(obs,action))
