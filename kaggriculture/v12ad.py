...
def agent(observation,configuration=None):
    ...
    try:
        plan=_PLANNER_NS['plan_terminal'](observation,configuration,baseline,max_simulations=512,passes=3,proposals_per_actor=24)
