...
def _build_orders(me, shed, seeds, inventories, inv, prices, day, hour, plan,
    ...
    if shed:
        for it in PRODUCTS:
            ...
            # KAIN-24: tighter tranches — 6 for dairy, 12 for strawberry
            # (deep-drain channels recover price between hours as the town
            # drains inventory).
            if k > 6 and it in ("MILK", "WOOL", "EGG") and day < 26:
                k = 6
            if k > 12 and it == "STRAWBERRY" and day < 26:
                k = 12
            if k > 0:
